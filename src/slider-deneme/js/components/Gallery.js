...
import left_ from "../../../lottie/left.png"
import right_ from "../../../lottie/right.png"
...
class Gallery extends React.PureComponent {
  ...
  componentDidMount() {
    ...
    this.setState({
      focusedIndex   : 1,
      focusedCardLeft: this.getCardCenterValue(1),
  ...
  render() {
    ...
    return (<TweenGroup id="port" style={{width:"100%"}} tween={this._slideArtTween(this.state.focusedCardLeft)}>
